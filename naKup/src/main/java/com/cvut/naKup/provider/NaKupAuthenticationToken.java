...
public class NaKupAuthenticationToken extends AbstractAuthenticationToken {
     ...
     */
    public NaKupAuthenticationToken(Object principal, Object credentials) {
        super(null);
     ...
     */
    public NaKupAuthenticationToken(Object principal, Object credentials, Collection<? extends GrantedAuthority> authorities, Object details) {
        super(authorities);
        this.principal = principal;
        this.credentials = credentials;
