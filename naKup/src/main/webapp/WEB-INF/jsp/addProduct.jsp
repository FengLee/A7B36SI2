...
<t:content>
	<jsp:body>
		...
		<h3><fmt:message key="profile.goods.add.title"/></h3>
		
		<div class="row">
			<jsp:include page="/WEB-INF/jsp/includes/profileMenu.jsp" />
			<div class="col-xs-12 col-sm-6 col-md-8">
				<form class="form-horizontal" role="form" id="command" action="<c:url value="/profile/${user.entityId}/products/add" />" method="POST">
					...
					<div class="form-group">
						...
						<div class="col-xs-12 col-sm-6 col-md-8">
							<input type="number" step="any" class="form-control" id="inputCost" name="cost" placeholder="Cost">
						</div>
					</div>
					<div class="form-group">
						<label for="inputDescription" class="col-lg-2 control-label"><fmt:message key="profile.goods.description" /></label>
						<div class="col-xs-12 col-sm-6 col-md-8">
							<textarea class="form-control" id="inputDescription" rows="3" name="text" placeholder="Description"></textarea>
						</div>
					</div>
					<div class="form-group">
						<div class="col-lg-offset-2 col-xs-12 col-sm-6 col-md-8">
							...
							<a href="<c:url value="/profile/${user.entityId}/products" />" class="btn btn-default"><fmt:message key="cancel" /></a>
						</div>
					</div>
				</form>
			</div>
